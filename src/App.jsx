  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'pbx':
        ...
        return isDemo
          ? <PbxConsole embedded pbxData={pbxData} handlers={handlers} customers={customers} sales={sales} products={products} onSimulateCall={() => handleStartCall('1-800-555-1234', 'inbound')} />
