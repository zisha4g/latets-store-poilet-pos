...
const PbxPage = () => {
    ...
    return <PbxConsole pbxData={pbxData} handlers={handlers} customers={data?.customers || []} sales={data?.sales || []} products={data?.products || []} onSimulateCall={() => handleStartCall('1-800-555-1234', 'inbound')} />;
};
