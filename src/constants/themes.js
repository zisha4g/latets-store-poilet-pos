export const themes = [
  ...
  },
  {
    ...
    colors: {
      '--background': '0 0% 100%',
      '--foreground': '255 50% 15%',
      '--card': '0 0% 100%',
      '--card-foreground': '255 50% 15%',
      '--popover': '0 0% 100%',
      '--popover-foreground': '255 50% 15%',
      '--primary': '262.1 83.3% 57.8%',
      '--primary-foreground': '0 0% 100%',
      '--secondary': '262.1 83.3% 97%',
  ...
  },
  {
    ...
    colors: {
      ...
      '--primary-foreground': '0 0% 100%',
      '--secondary': '217.2 91.2% 97%',
      '--secondary-foreground': '217.2 91.2% 59.8%',
      '--muted': '210 40% 96.1%',
      '--muted-foreground': '215.4 16.3% 46.9%',
      '--accent': '217.2 91.2% 97%',
      '--accent-foreground': '217.2 91.2% 59.8%',
      '--destructive': '0 84.2% 60.2%',
      '--destructive-foreground': '210 40% 98%',
      '--border': '217.2 91.2% 91.4%',
      '--input': '217.2 91.2% 91.4%',
